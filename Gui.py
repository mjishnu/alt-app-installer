...
class Ui_MainProgram(object):
    def setupUi(self, MainProgram):
        ...
        self.pause_btn.setGeometry(QtCore.QRect(360, 100, 111, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.resume_btn.setGeometry(QtCore.QRect(360, 100, 111, 31))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MainProgram):
        ...
        self.pause_btn.setText(_translate("MainProgram", "Pause"))
        self.resume_btn.setText(_translate("MainProgram", "Resume"))
