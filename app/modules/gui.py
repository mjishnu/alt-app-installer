...
class Ui_MainProgram(object):
    def setupUi(self, MainProgram):
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("../data/images/unchecked.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon10.addPixmap(QtGui.QPixmap("../data/images/checked.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        icon10.addPixmap(QtGui.QPixmap("../data/images/unchecked.png"), QtGui.QIcon.Mode.Selected, QtGui.QIcon.State.Off)
        icon10.addPixmap(QtGui.QPixmap("../data/images/checked.png"), QtGui.QIcon.Mode.Selected, QtGui.QIcon.State.On)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("../data/images/link.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
