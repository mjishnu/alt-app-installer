...
class Ui_MainProgram(object):
    def setupUi(self, MainProgram):
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("modules\\data/images/unchecked.png"), QtGui.QIcon.Mode.Selected, QtGui.QIcon.State.Off)
        icon8.addPixmap(QtGui.QPixmap("modules\\data/images/checked.png"), QtGui.QIcon.Mode.Selected, QtGui.QIcon.State.On)
