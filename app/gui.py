...
class Ui_MainProgram(object):
    def setupUi(self, MainProgram):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("data/images/clear.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionclear_cache.setIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("data/images/update.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionCheck_For_Updates.setIcon(icon1)
        self.actionCheck_For_Updates.setObjectName("actionCheck_For_Updates")
        self.actionAbout = QtGui.QAction(MainProgram)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("data/images/about.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionAbout.setIcon(icon2)
        self.actionAbout.setStatusTip("")
        self.actionAbout.setObjectName("actionAbout")
        self.actionHelp = QtGui.QAction(MainProgram)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("data/images/help.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionHelp.setIcon(icon3)
        self.actionHelp.setObjectName("actionHelp")
        self.actionOpen_Logs = QtGui.QAction(MainProgram)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("data/images/log.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionOpen_Logs.setIcon(icon4)
        ...
        self.actioninstall_From_File = QtGui.QAction(MainProgram)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("data/images/file.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actioninstall_From_File.setIcon(icon5)
        self.actioninstall_From_File.setObjectName("actioninstall_From_File")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("data/images/downloads.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionDownloads.setIcon(icon6)
