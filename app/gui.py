...
class Ui_MainProgram(object):
    def setupUi(self, MainProgram):
        ...
        self.actionIgnore_Architecture = QtGui.QAction(MainProgram)
        self.actionIgnore_Architecture.setCheckable(True)
        self.actionIgnore_Architecture.setIcon(icon9)
        self.actionIgnore_Architecture.setObjectName("actionIgnore_Architecture")
        self.menuDependencies.addSeparator()
        self.menuDependencies.addAction(self.actionIgnore_Latest_Version)
        self.menuDependencies.addAction(self.actionIgnore_Architecture)
    ...
    def retranslateUi(self, MainProgram):
        ...
        self.actionIgnore_Architecture.setText(_translate("MainProgram", "Ignore Architecture"))
